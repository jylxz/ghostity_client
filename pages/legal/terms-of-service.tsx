        ...
        <div className="max-w-[75ch] text-sm flex flex-col items-center gap-10 px-4">
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              terms and conditions, but the terms and conditions of{" "}
              <strong>YouTube</strong> and <strong>Twitch</strong>.
            </p>
            <p>
              A link to YouTube&apos;s Terms of Services can be found{" "}
              <a
            ...
            <p>
              A link to Twitch&apos;s Terms of Services can be found{" "}
              <a
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-bold">Content Liability:</h2>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-base font-bold">Reservation of Rights:</h2>
            <p>
