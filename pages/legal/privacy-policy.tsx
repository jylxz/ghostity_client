        ...
        <div className="max-w-[75ch] text-sm flex flex-col items-center gap-10 px-4">
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              For example, you won’t be able to receive our Newsletter or
              contact us directly from the website. Users who are uncertain
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              We encourage you to be aware when you leave our website and read
