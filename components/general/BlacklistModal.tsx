...
export default function BlacklistModal({
  ...
  const handleBlacklist = async () => 
    axios.delete("https://api.ghostity.com/admin/channel", {
      headers: {
  ...
  return (
    <motion.div initial={{translateX: 500}} animate={{translateX: 0}} exit={{translateX: 500}} className="fixed flex items-center gap-1 bottom-4 right-2 p-2 bg-red-400 text-white z-40 w-80 rounded">
