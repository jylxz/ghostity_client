...
export default function GridWrapper({
  ...
  const column = {
    ...
    xxsmall: "grid-cols-[repeat(auto-fill,_minmax(9rem,_1fr))]",
  };
  ...
  return (
    <motion.div
      ...
      className={`grid grid-flow-row auto-rows-fr ${column[colSize]} gap-[clamp(1rem,_1.6rem,_1.8rem)] justify-items-center`}
    >
      {children}
    </motion.div>
  );
